...
class PatientAdmin(admin.ModelAdmin):
    list_display = (
        'patient_id', 
        'full_name',   # Uses @property on the Patient model
        'has_insurance',
    ...
    list_filter = ('blood_group', 'registration_date', 'insurance')
...
class VitalSignAdmin(admin.ModelAdmin):
    list_display = ('patient', 'temperature', 'blood_pressure_systolic', 'heart_rate', 'timestamp', 'recorded_by')
    search_fields = ('patient__user__first_name', 'patient__user__last_name', 'recorded_by__username')
    list_filter = ('timestamp', 'recorded_by')
    raw_id_fields = ('patient', 'recorded_by')

    # The encounter_patient method is no longer needed
    # as we are now directly referencing 'patient' in list_display.
...
@admin.register(VisitorEntryExit)
class VisitorEntryExitAdmin(admin.ModelAdmin):
    list_display = ('event_type', 'timestamp', 'notes')
    list_filter = ('event_type', 'timestamp')
    search_fields = ('notes',)
    readonly_fields = ('timestamp',)

# --- Corrected BillingAdmin --
